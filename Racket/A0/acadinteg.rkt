...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname acadinteg) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor mixed-fraction #f #t none #f () #t)))
...
;; Replace the 0 with the policy number covering "Student Discipline"
(define student-discipline-policy 71)

;; "Sign" the document by placing your userid in the quotes.
(define userid "y256wang")   ;; A 2-8 character alphanumeric id
